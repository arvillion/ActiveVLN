...
from verl.workers.agent.parallel_env_vlnce import agent_rollout_loop
...
class vLLMRollout(BaseRollout):
    def __init__(self, model_path: str, config: DictConfig, tokenizer, model_hf_config, **kwargs):
        ...
        self.inference_engine = LLM(
            ...
            **({
                ...
                "mm_processor_kwargs": {
                    "min_pixels": self.config.agent.min_pixels,
                    "max_pixels": self.config.agent.max_pixels,
                },
    ...
    def generate_sequences(self, prompts: DataProto, **kwargs) -> DataProto:
        ...
        keys_to_remove = ['data_source', 'episode_id', 'history_actions', 'step_budget', 'turn_budget', 'env_name', "full_gt_action_seqs"]
